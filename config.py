...
# 기본 small+large-v3-turbo. tiny/base/small/medium/large-v3/large-v3-turbo 등 faster-whisper 모델명.
MEET_STT_REALTIME_MODEL = os.getenv("MEET_STT_REALTIME_MODEL", "small")
MEET_STT_MODEL = os.getenv("MEET_STT_MODEL", "large-v3-turbo")
